...
The Luba Empire is the central African kingdom of the Upemba
Depression: copper-cross currency, sacred Mulopwe kingship, and the
Bambudye council whose lukasa memory boards held the institutional
knowledge of state. Forming it gives you a divine-kingship empire built
around the Kalala Ilunga foundation myth and the copper-iron
metallurgy of the lakeshore.

The two paths split between **Mulopwe divine authority** (sacred
kingship, autocratic) and **Bambudye wisdom** (council institution,
checked monarchy).
...
2. **Hold lake_upemba.** This is the single allow-block requirement.
   ...
   LBA is geographically closer.
3. **Hit 65% of a three-area pool.** East Lunda, Kasongo, and Moshiko.
   Compact territory; consolidating tribal neighbours covers most of it.
4. **Pick your path on formation.**
   - *The Mulopwe's word is law*: divine kingship, autocratic emphasis.
   - *The Bambudye shall guide us*: council institution, checked
     monarchy.
...
- **Path A: The Mulopwe's Conquest.** Conquest line. Stage 1 marches
