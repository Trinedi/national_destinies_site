...
priority_starters:
  - tag: HAB
    note: "Austria. The easiest start and the headline fantasy. You already hold Vienna, and both other crowns can be won by marriage instead of war."
  - tag: HUN
    note: "Hungary. The bulkiest start. You hold Buda and expand naturally toward Vienna and Prague."
  - tag: BOH
    note: "Bohemia. The smallest of the three. You hold Prague and lean hardest on the union road."
hide_auto: true
---
...
3. Deepen your pacts with **Propose the Erbverbruederung**, and convene
   a diet while your cause is ahead.
4. Push the union cause to **100**. This calls the Congress of the
   Danube, which acclaims its strongest backer.
...
3. **Own your own capital.** Hungary needs Buda. Bohemia needs Prague.
   Austria is already covered by Vienna.
4. **Settle all three crowns.** Austria, Bohemia and Hungary must each
   be you, gone, your subject, or your union junior. You never have to
   annex them.
...
| Origin | Holds already | Still to arrange |
|---|---|---|
| **Austria** | Vienna, and its own capital rule | Bohemia and Hungary settled |
...
|---|---|---|
| Identity | Bulwark of Christendom against the Ottoman frontier | The centralized state, three crowns in one chancery |
| Strong on | Manpower, levies, garrisons, land morale, hostile attrition, tolerance | Control, cabinet and legislative efficiency, tax, assimilation, lower separatism |
