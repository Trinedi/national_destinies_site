...
priority_starters:
  - tag: KBO
    note: "Kanem-Bornu. The Sayfawa starter. Sunni Kanembu, already owns both Ngazargamu and Njimi, and is the only realistic path to formation."
hide_auto: true
---

## Concept

Kanem-Bornu is the Sayfawa restoration: the dynasty driven from Kanem
by the Bulala in the 14th century, refounded in Bornu, and finally
reuniting both halves of the Lake Chad world. Forming it is a Sahelian
imperial fantasy built around armoured cavalry, ribat frontiers, and
trans-Saharan caravan trade through Tripoli.
...
2. **Hold Ngazargamu and Njimi.** KBO owns both at start, satisfying
   the allow block immediately.
3. **Hit 55% of a wide six-area pool.** Bornu, Kanem, Logone, Wadai,
   Air, and North Hausa. Lower fraction than most level 3 formables,
   but the area pool is enormous; expand east into Wadai and west into
   Hausaland or south into Logone.
4. **Pick your path on formation.**
   - *By the lance and the ribat*: Mai's armoured cavalry and frontier
     ribats, military emphasis.
   - *By the caravan and the market*: trans-Saharan trade, Tripoli
     route economic emphasis.
...
- **Path A: Sword of the Mai.** Conquest line. Stage 1 takes Kano and
